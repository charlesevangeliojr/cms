    ...
    <div class="overflow-hidden rounded-xl bg-gradient-to-r from-gray-900 via-gray-800 to-gray-700 text-white shadow">
        <div class="flex flex-col gap-4 px-6 py-6 sm:px-8 lg:flex-row lg:items-center lg:justify-between">
            ...
            <div class="flex shrink-0 gap-2">
                <a href="{{ url('/') }}"
                   class="inline-flex items-center gap-2 rounded-xl bg-white px-4 py-2 text-sm font-medium text-gray-900 hover:bg-gray-100">
                ...
                <a href="{{ url('/about') }}"
                   class="inline-flex items-center gap-2 rounded-xl border border-gray-500 px-4 py-2 text-sm font-medium text-white hover:bg-white/10">
                    About Page
                </a>
            </div>
        </div>
    ...
    <div class="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
        <div class="rounded-xl border border-gray-200 bg-white p-5 shadow-sm">
            <div class="flex items-center gap-3">
                <span class="flex size-10 items-center justify-center rounded-xl bg-blue-100 text-blue-600">
        ...
        <div class="rounded-xl border border-gray-200 bg-white p-5 shadow-sm">
            <div class="flex items-center gap-3">
                <span class="flex size-10 items-center justify-center rounded-xl bg-green-100 text-green-600">
        ...
        <div class="rounded-xl border border-gray-200 bg-white p-5 shadow-sm">
            <div class="flex items-center gap-3">
                <span class="flex size-10 items-center justify-center rounded-xl bg-amber-100 text-amber-600">
        ...
        <div class="rounded-xl border border-gray-200 bg-white p-5 shadow-sm">
            <div class="flex items-center gap-3">
                <span class="flex size-10 items-center justify-center rounded-xl bg-red-100 text-red-600">
            ...
            <div class="rounded-xl border border-gray-200 bg-white p-5 shadow-sm">
                ...
                <div class="mt-4 space-y-2">
                    @foreach (($pages ?? []) as $link)
                        <a href="{{ url($link['url']) }}"
                           class="flex items-center justify-between rounded-xl border border-gray-200 px-4 py-2.5 text-sm font-medium hover:border-gray-900 hover:bg-gray-900 hover:text-white">
                            {{ $link['label'] }} Page
